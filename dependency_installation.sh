...
dnf install automake autoconf libtool flex bison openssl-devel libxml2-devel python-devel \
...
rpcgen libtirpc-devel make python3-devel rsync libuuid-devel -y
